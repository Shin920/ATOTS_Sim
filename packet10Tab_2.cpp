...
IMPLEMENT_DYNAMIC(packet10Tab_2, CDialogEx)

packet10Tab_2::packet10Tab_2(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_DLG_SEND_12, pParent)
{
	Init();
}

packet10Tab_2::~packet10Tab_2()
{
	Release();
}

void packet10Tab_2::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(packet10Tab_2, CDialogEx)
	ON_WM_ERASEBKGND()
	ON_WM_CTLCOLOR()
	ON_BN_CLICKED(IDC_CHB_AUTO, &packet10Tab_2::OnBnClickedChbAuto)
	ON_CBN_SELCHANGE(IDC_CMB_PACKET, &packet10Tab_2::OnCbnSelchangeCmbPacket)
	ON_BN_CLICKED(IDC_BTN_SEND, &packet10Tab_2::OnBnClickedBtnSend)
...
void packet10Tab_2::Release()
{
	delete pHeaderStructure;
}

BOOL packet10Tab_2::OnInitDialog()
{
...
void packet10Tab_2::PacketHeaderCtrlToStructure(const CMFCPropertyGridProperty* bodyProperty, ATO_Header& p)
{
...
BOOL packet10Tab_2::OnEraseBkgnd(CDC* pDC)
{
...
HBRUSH packet10Tab_2::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
void packet10Tab_2::OnBnClickedChbAuto()
{
...
void packet10Tab_2::OnCbnSelchangeCmbPacket()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
void packet10Tab_2::OnBnClickedBtnSend()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	// Sa-Conn 연결여부 확인 필요
...
int packet10Tab_2::getPacketCounter()
{
	m_nPacketCounter++;
...
BOOL packet10Tab_2::PreTranslateMessage(MSG* pMsg)
{
