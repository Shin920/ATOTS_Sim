...
IMPLEMENT_DYNAMIC(packet07Tab_2, CDialogEx)

packet07Tab_2::packet07Tab_2(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_DLG_SEND_10, pParent), pSPStructure(nullptr)
{
	Init();
}

packet07Tab_2::~packet07Tab_2()
{
	Release();
}

void packet07Tab_2::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(packet07Tab_2, CDialogEx)
	ON_WM_ERASEBKGND()
	ON_WM_CTLCOLOR()
	ON_BN_CLICKED(IDC_CHB_AUTO, &packet07Tab_2::OnBnClickedChbAuto)
	ON_CBN_SELCHANGE(IDC_CMB_PACKET, &packet07Tab_2::OnCbnSelchangeCmbPacket)
	ON_BN_CLICKED(IDC_BTN_SEND, &packet07Tab_2::OnBnClickedBtnSend)
	ON_BN_CLICKED(IDC_BTN_SAVE, &packet07Tab_2::OnBnClickedBtnSave)
	ON_BN_CLICKED(IDC_BTN_LOAD, &packet07Tab_2::OnBnClickedBtnLoad)
	ON_BN_CLICKED(IDC_BUTTON1, &packet07Tab_2::OnBnClickedButton1)
END_MESSAGE_MAP()


// CSendTab 메시지 처리기

void packet07Tab_2::Init()
{
...
BOOL packet07Tab_2::OnInitDialog()
{
...
void packet07Tab_2::PacketHeaderCtrlToStructure(const CMFCPropertyGridProperty* bodyProperty, ATO_Header& p)
{
...
void packet07Tab_2::PacketSPCtrlToStructure(const CMFCPropertyGridProperty* bodyProperty, TS_OB_Packet07_SPStruct& p)
{
...
BOOL packet07Tab_2::OnEraseBkgnd(CDC* pDC)
{
...
HBRUSH packet07Tab_2::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
void packet07Tab_2::OnBnClickedChbAuto()
{
...
void packet07Tab_2::OnCbnSelchangeCmbPacket()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
void packet07Tab_2::OnBnClickedBtnSend()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	// Sa-Conn 연결여부 확인 필요
...
void packet07Tab_2::PacketSPStructrureToINI(TS_OB_Packet07_SPStruct& p)
{
	if (&p == nullptr)return;
...
BOOL packet07Tab_2::RequestedLoadSPFromFile(int num, CString path)
{
...
BOOL packet07Tab_2::LoadPacketSPFromFile()
{
	TS_OB_Packet07_SPStruct& p = *pFileSPStructure;
	if (&p == nullptr)return FALSE;
...
BOOL packet07Tab_2::initLoadPacketSPFromFile()
{
	TS_OB_Packet07_SPStruct& p = *pFileSPStructure;
	if (&p == nullptr)return FALSE;
	static CString pathName = SPDefaultConfigFileName;
...
void packet07Tab_2::LoadPacketSPFromFile_StaticData(string& configTXT, TS_OB_Packet07_SPStruct& p)
{
	TextTablePacketSP& idcList = TextTablePacketSP::GetInstance();
...
void packet07Tab_2::ReLoadPacketSP()
{
...
void packet07Tab_2::OnBnClickedBtnSave()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
void packet07Tab_2::OnBnClickedBtnLoad()
{
...
int packet07Tab_2::getPacketCounter()
{
	m_nPacketCounter++;
...
void packet07Tab_2::OnBnClickedButton1()
{
	BYTE	buffer[1024]{};
	UINT32  nPos = 0;
	int bodylength = 0;
...
BOOL packet07Tab_2::PreTranslateMessage(MSG* pMsg)
{
