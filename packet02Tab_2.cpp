...
IMPLEMENT_DYNAMIC(packet02Tab_2, CDialogEx)

packet02Tab_2::packet02Tab_2(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_DLG_SEND_8, pParent), pHSRejStructure(nullptr)
{
	Init();
}

packet02Tab_2::~packet02Tab_2()
{
	Release();
}

void packet02Tab_2::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(packet02Tab_2, CDialogEx)
	ON_WM_ERASEBKGND()
	ON_WM_CTLCOLOR()
	ON_BN_CLICKED(IDC_CHB_AUTO, &packet02Tab_2::OnBnClickedChbAuto)
	ON_CBN_SELCHANGE(IDC_CMB_PACKET, &packet02Tab_2::OnCbnSelchangeCmbPacket)
	ON_BN_CLICKED(IDC_BTN_SEND, &packet02Tab_2::OnBnClickedBtnSend)
	ON_BN_CLICKED(IDC_BTN_SAVE, &packet02Tab_2::OnBnClickedBtnSave)
	ON_BN_CLICKED(IDC_BTN_LOAD, &packet02Tab_2::OnBnClickedBtnLoad)
END_MESSAGE_MAP()


// CSendTab 메시지 처리기

void packet02Tab_2::Init()
{
...
BOOL packet02Tab_2::OnInitDialog()
{
...
void packet02Tab_2::PacketHeaderCtrlToStructure(const CMFCPropertyGridProperty* bodyProperty, ATO_Header& p)
{
...
void packet02Tab_2::PacketHSRejCtrlToStructure(const CMFCPropertyGridProperty* bodyProperty, TS_OB_Packet02_HSRejStruct& p)
{
	const CMFCPropertyGridProperty& cp = *(bodyProperty);
...
BOOL packet02Tab_2::OnEraseBkgnd(CDC* pDC)
{
...
HBRUSH packet02Tab_2::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
void packet02Tab_2::OnBnClickedChbAuto()
{
...
void packet02Tab_2::OnCbnSelchangeCmbPacket()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
void packet02Tab_2::OnBnClickedBtnSend()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	// Sa-Conn 연결여부 확인 필요
...
void packet02Tab_2::PacketHsRejStructureToINI(TS_OB_Packet02_HSRejStruct& p)
{
	if (&p == nullptr)return;
...
BOOL packet02Tab_2::LoadPacketHSRejFromFile()
{
...
BOOL packet02Tab_2::initLoadPacketHSRejFromFile()
{
	TS_OB_Packet02_HSRejStruct& p = *pFileHSRejStructure;
	if (&p == nullptr)return FALSE;
	static CString pathName = HSRejDefaultConfigFileName;
...
void packet02Tab_2::LoadPacketHSRejFromFile_StaticData(string& configTXT, TS_OB_Packet02_HSRejStruct& p)
{
	size_t strIdx, strEndlineIdx;
	string currentLine;
...
void packet02Tab_2::OnBnClickedBtnLoad()
{
...
int packet02Tab_2::getPacketCounter()
{
	m_nPacketCounter++;
...
BOOL packet02Tab_2::PreTranslateMessage(MSG* pMsg)
{
