...
IMPLEMENT_DYNAMIC(packet01Tab_2, CDialogEx)

packet01Tab_2::packet01Tab_2(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_DLG_SEND_7, pParent), pHSAckStructure(nullptr)
{
	Init();

}

packet01Tab_2::~packet01Tab_2()
{
	Release();
}

void packet01Tab_2::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(packet01Tab_2, CDialogEx)
	ON_WM_ERASEBKGND()
	ON_WM_CTLCOLOR()
	ON_BN_CLICKED(IDC_CHB_AUTO, &packet01Tab_2::OnBnClickedChbAuto)
	ON_CBN_SELCHANGE(IDC_CMB_PACKET, &packet01Tab_2::OnCbnSelchangeCmbPacket)
	ON_BN_CLICKED(IDC_BTN_SEND, &packet01Tab_2::OnBnClickedBtnSend)
	ON_BN_CLICKED(IDC_BTN_SAVE, &packet01Tab_2::OnBnClickedBtnSave)
	ON_BN_CLICKED(IDC_BTN_LOAD, &packet01Tab_2::OnBnClickedBtnLoad)
END_MESSAGE_MAP()


// CSendTab 메시지 처리기

void packet01Tab_2::Init()
{
...
BOOL packet01Tab_2::OnInitDialog()
{
...
void packet01Tab_2::PacketHeaderCtrlToStructure(const CMFCPropertyGridProperty* bodyProperty, ATO_Header& p)
{
...
void packet01Tab_2::PacketHSAckCtrlToStructure(const CMFCPropertyGridProperty* bodyProperty, TS_OB_Packet01_HSAckStruct& p)
{
	//패킷정보를 담고있는 프로퍼티
	const CMFCPropertyGridProperty& cp = *(bodyProperty);
...
BOOL packet01Tab_2::OnEraseBkgnd(CDC* pDC)
{
...
HBRUSH packet01Tab_2::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
void packet01Tab_2::OnBnClickedChbAuto()
{
...
void packet01Tab_2::OnCbnSelchangeCmbPacket()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
void packet01Tab_2::OnBnClickedBtnSend()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	// Sa-Conn 연결여부 확인 필요
...
void packet01Tab_2::PacketHSAckStructureToINI(TS_OB_Packet01_HSAckStruct& p)
{
	if (&p == nullptr)return;
...
BOOL packet01Tab_2::LoadPacketHSAckFromFile()
{
...
BOOL packet01Tab_2::initLoadPacketHSAckFromFile()
{
	TS_OB_Packet01_HSAckStruct& p = *pFileHSAckStructure;
	if (&p == nullptr)return FALSE;
	static CString pathName = HSAckDefaultConfigFileName;
...
void packet01Tab_2::LoadPacketHSAckFromFile_StaticData(string& configTXT, TS_OB_Packet01_HSAckStruct& p)
{
	size_t strIdx, strEndlineIdx;
	string currentLine;
...
void packet01Tab_2::ReLoadPacketHSAck()
{
...
void packet01Tab_2::OnBnClickedBtnSave()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
void packet01Tab_2::OnBnClickedBtnLoad()
{
...
int packet01Tab_2::getPacketCounter()
{
	m_nPacketCounter++;
...
BOOL packet01Tab_2::PreTranslateMessage(MSG* pMsg)
{
